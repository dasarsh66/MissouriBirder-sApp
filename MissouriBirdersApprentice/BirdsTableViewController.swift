...
class BirdsTableViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    var county:County!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.imageView?.image = county.Birds[indexPath.row].img
        // Configure the cell...
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let birdVC:BirdViewController = UIStoryboard(name: "Main", bundle:nil).instantiateViewController(withIdentifier:"BirdViewCotroller") as! BirdViewController
        birdVC.brd = county.Birds[indexPath.row]
